...
import com.hexszeug.werewolf.game.model.customprops.CustomPropertiesTestUtils;
...
class PlayerImplTest {
    ...
    void providesIdentity() {
        ...
        assertThat(player.getRole()).isEqualTo(Role.HUNTER);
    }
    ...
    void storesDeathInfo() {
        ...
        assertThat(player.getDeathReason()).isEqualTo(DeathReason.NIGHT);
